                    ...
                    >
                      <div style={{ width: "100%", float: "left" }}>
                        ...
                        >
                          ...
                          {array[index].type === "multiple_choice" ? (
                            array[index].multiple_choice_items.map(
                              (i, index) => (
