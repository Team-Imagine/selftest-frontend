      ...
      >
        ...
        <CardDeck>
          ...
          <Card border="dark" style={{ width: "18rem" }}>
            ...
            <Card.Body>
              ...
              <Card.Text>글쓰기, 한국사, 중국어, 영어</Card.Text>
            </Card.Body>
            <Card.Footer>
              <Button variant="info">공부하러가기</Button>
            </Card.Footer>
          ...
          <Card border="dark" style={{ width: "18rem" }}>
            ...
            <Card.Body>
              ...
              <Card.Text>유아교육론, 유아놀이지도, 영유아발달</Card.Text>
            </Card.Body>
            <Card.Footer>
        ...
        <CardDeck>
          <Card border="dark" style={{ width: "18rem" }}>
            ...
            <Card.Body>
              <Card.Title>기계공학과</Card.Title>
              <Card.Text>열역학, 동역학, 고체역학</Card.Text>
            </Card.Body>
            <Card.Footer>
              <Button variant="info">공부하러가기</Button>
            </Card.Footer>
          ...
          <Card border="dark" style={{ width: "18rem" }}>
            ...
            <Card.Body>
              ...
              <Card.Text>재무관리, 투자론, 국제경영학</Card.Text>
            </Card.Body>
            <Card.Footer>
              <Button variant="info">공부하러가기</Button>
            </Card.Footer>
